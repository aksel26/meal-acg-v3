...
const RISK_STYLES = {
  ...
  high: "bg-slate-50 text-slate-700",
} as const;
          ...
          <table className="w-full min-w-full text-left text-sm">
            <thead>
              <tr className="border-b border-slate-100 text-xs font-medium text-slate-400">
                ...
                <th className="px-3 py-2 font-medium">위험도</th>
                <th className="px-3 py-2 font-medium">사유</th>
                <th className="px-3 py-2 font-medium">메타데이터</th>
              ...
              {isLoading ? (
                ...
                data.map((log) => (
                  ...
                  >
                    ...
                    <td className="max-w-[22rem] px-3 py-3 text-xs text-slate-500">
