    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="w-7 h-7 flex items-center justify-center bg-slate-900 text-white text-sm font-bold rounded-md">
            {groupNumber}
          </span>
          <span className="text-sm font-medium text-slate-600">조</span>
        </div>
        <span className="text-xs text-slate-400">{groupMembers.length}명</span>
      </div>
