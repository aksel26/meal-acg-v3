          ...
          <table className="w-full">
            <thead className="sticky top-0 z-10 bg-white">
              <tr className="border-b border-slate-100 text-xs font-medium text-slate-400">
                ...
                <th className="w-16 whitespace-nowrap px-3 py-2 text-center font-medium">
                  입력완료
                </th>
                <th className="px-3 py-2 text-center font-medium">
                  정산
                ...
                filteredUsers.map((user, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-right text-sm font-medium tabular-nums text-slate-600">
                        {formatCurrency(user.total_allowance)}
                      </td>
                      <td className="px-3 py-3 text-right text-sm font-medium tabular-nums text-[#94a3b8]">
