    ...
    for (const member of members) {
      ...
      allDates.forEach(({ date, dateStr, month }, index) => {
        ...
        row.values = [
          ...
          isExcludedAttendance ? null : (log?.lunch_store || null), // I: 중식 상호명
          isExcludedAttendance ? null : (log?.lunch_amount || null), // J: 중식 금액
          null, // K: 알림용
          isExcludedAttendance ? null : (log?.lunch_payer || null), // L: 중식 비고
          isExcludedAttendance ? null : (log?.dinner_store || null), // M: 석식 상호명
          isExcludedAttendance ? null : (log?.dinner_amount || null), // N: 석식 금액
          isExcludedAttendance ? null : (log?.dinner_payer || null), // O: 석식 비고
          isExcludedAttendance ? null : (log?.breakfast_store || null), // P: 조식 상호명
          isExcludedAttendance ? null : (log?.breakfast_amount || null), // Q: 조식 금액
          isExcludedAttendance ? null : (log?.breakfast_payer || null), // R: 조식 비고
        ];
