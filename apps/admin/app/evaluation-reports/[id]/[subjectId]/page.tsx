              ...
              <table className="w-full border-collapse text-left text-[11px]">
                <thead>
                  <tr className="border-b border-slate-100 text-slate-400">
                    ...
                    <th className="w-[14%] px-2 py-2 font-medium">키워드</th>
                    <th className="w-[14%] px-2 py-2 font-medium">하위 키워드</th>
                    <th className="w-[30%] px-3 py-2 font-medium">문항</th>
                    <th className="px-2 py-2 text-right font-medium">답변</th>
                    <th className="px-2 py-2 text-right font-medium">평균</th>
                    <th className="px-2 py-2 text-right font-medium">가중</th>
                    <th className="px-2 py-2 text-right font-medium">상사</th>
                    <th className="px-2 py-2 text-right font-medium">동료</th>
                  </tr>
                </thead>
                <tbody>
                  {data.questionScores.length === 0 ? (
                    ...
                    data.questionScores.map((item) => (
                      <tr key={item.key} className="border-b border-slate-100 align-top last:border-b-0">
                        ...
                        <td className="px-3 py-2 font-medium leading-5 text-slate-800">
                          {item.label}
                        </td>
