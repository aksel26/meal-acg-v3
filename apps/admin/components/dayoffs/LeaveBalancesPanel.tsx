      ...
      <div className="overflow-x-auto rounded-xl border bg-white">
        <table className="w-full text-sm whitespace-nowrap">
          <thead className="border-b bg-slate-50">
            <tr>
              <th className="px-3 py-2.5 text-left text-xs font-medium text-slate-500 w-20">
                이름
              </th>
              <th className="px-2 py-2.5 text-left text-xs font-medium text-slate-500 w-14">
                직급
              </th>
              {allLeaveTypes.map((t) => (
                <th
                  key={t.id}
                  className="px-1.5 py-2.5 text-center text-[11px] font-medium text-slate-500 min-w-[40px] border-l border-slate-200"
                >
                  {t.name}
                </th>
              ))}
              <th className="px-2 py-2.5 text-center text-xs font-medium text-slate-700 bg-slate-100">
                합계
              </th>
            </tr>
          </thead>
