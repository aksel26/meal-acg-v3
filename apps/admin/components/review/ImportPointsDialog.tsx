          ...
          <>
            <div className="flex items-center justify-between gap-3 text-sm">
              ...
              <div className="flex items-center gap-2 text-xs text-slate-500">
                ...
                <span className="text-emerald-600">유효 {stats.valid}건</span>
                {stats.noMember > 0 && (
                  <>
                    <span className="text-slate-300">|</span>
                    <span className="text-amber-600">미매칭 {stats.noMember}건</span>
                  </>
                )}
                {stats.error > 0 && (
                  <>
                    <span className="text-slate-300">|</span>
                    <span className="text-rose-600">오류 {stats.error}건</span>
                  </>
                )}
              </div>
            </div>
