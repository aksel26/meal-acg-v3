...
export const ADMIN_PERMISSION_METADATA: AdminPermissionMetadata[] = [
  ...
  {
    permission: "members:sensitive:read",
    label: "직원 민감정보 조회",
    group: "민감정보/다운로드",
    highRisk: true,
  },
  {
    permission: "members:sensitive:write",
    label: "직원 민감정보 수정",
    group: "민감정보/다운로드",
    highRisk: true,
  },
  ...
  {
    permission: "offboarding:write",
    label: "오프보딩 관리",
    group: "직원/조직",
  },
  { permission: "seating:read", label: "좌석 조회", group: "자산/시설" },
  { permission: "seating:write", label: "좌석 관리", group: "자산/시설" },
  { permission: "parking:read", label: "주차 조회", group: "자산/시설" },
  { permission: "parking:write", label: "주차 관리", group: "자산/시설" },
  {
  ...
  {
    permission: "corporate_card:write",
    label: "기업카드 관리",
    group: "재무/평가",
  },
  {
  ...
  {
    permission: "company_documents:write",
    label: "전사 자료 관리",
    group: "자산/시설",
  },
  {
