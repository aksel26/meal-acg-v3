...
export type Database = {
  ...
  careers: {
    Tables: {
      applicant_files: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "applicant_files_application_id_applicant_id_fkey"
            columns: ["application_id", "applicant_id"]
            isOneToOne: false
      ...
      application_cover_letter_answers: {
        Row: {
          answer: string
          application_id: string
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "application_cover_letter_answers_application_id_fkey"
      ...
      application_final_results: {
        ...
        Relationships: [
          {
            foreignKeyName: "application_final_results_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: true
            referencedRelation: "applications"
            referencedColumns: ["id"]
      ...
      application_separations: {
        ...
        Relationships: [
          {
            foreignKeyName: "application_separations_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id"]
      ...
      application_stage_history: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            isOneToOne: false
            referencedRelation: "job_posting_stages"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "application_stage_history_from_status_id_fkey"
            columns: ["from_status_id", "from_stage_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "application_stage_history_to_status_id_fkey"
            columns: ["to_status_id", "to_stage_id"]
            isOneToOne: false
            referencedRelation: "stage_statuses"
            referencedColumns: ["id", "stage_id"]
          },
      ...
      application_stage_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "application_stage_records_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "application_stage_records_stage_id_fkey"
            columns: ["stage_id"]
            isOneToOne: false
            referencedRelation: "job_posting_stages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "application_stage_records_status_id_stage_id_fkey"
            columns: ["status_id", "stage_id"]
            isOneToOne: false
            referencedRelation: "stage_statuses"
            referencedColumns: ["id", "stage_id"]
          },
      ...
      applications: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "applications_current_stage_id_job_posting_id_fkey"
            columns: ["current_stage_id", "job_posting_id"]
            isOneToOne: false
            referencedRelation: "job_posting_stages"
            referencedColumns: ["id", "job_posting_id"]
          },
          {
            foreignKeyName: "applications_current_status_id_current_stage_id_fkey"
            columns: ["current_status_id", "current_stage_id"]
            isOneToOne: false
            referencedRelation: "stage_statuses"
            referencedColumns: ["id", "stage_id"]
          },
      ...
      cover_letter_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "cover_letter_questions_job_posting_id_fkey"
            columns: ["job_posting_id"]
            isOneToOne: false
            referencedRelation: "job_postings"
            referencedColumns: ["id"]
      ...
      job_posting_stages: {
        ...
        Relationships: [
          {
            foreignKeyName: "job_posting_stages_job_posting_id_fkey"
            columns: ["job_posting_id"]
            isOneToOne: false
            referencedRelation: "job_postings"
            referencedColumns: ["id"]
      ...
      message_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "message_history_application_id_fkey"
            columns: ["application_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id"]
      ...
      schedule_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedule_events_application_id_job_posting_id_fkey"
            columns: ["application_id", "job_posting_id"]
            isOneToOne: false
            referencedRelation: "applications"
            referencedColumns: ["id", "job_posting_id"]
          },
          {
            foreignKeyName: "schedule_events_stage_id_job_posting_id_fkey"
            columns: ["stage_id", "job_posting_id"]
            isOneToOne: false
            referencedRelation: "job_posting_stages"
            referencedColumns: ["id", "job_posting_id"]
          },
      ...
      stage_message_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "stage_message_rules_stage_id_fkey"
            columns: ["stage_id"]
            isOneToOne: false
            referencedRelation: "job_posting_stages"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "stage_message_rules_status_id_stage_id_fkey"
            columns: ["status_id", "stage_id"]
            isOneToOne: false
            referencedRelation: "stage_statuses"
            referencedColumns: ["id", "stage_id"]
    ...
    Functions: {
      ...
      clone_process_preset_to_posting: {
        Args: { p_actor_admin_id: string; p_job_posting_id: string }
        Returns: Json
      }
      consume_sso_handoff: {
      ...
      create_application: {
        Args: { p_actor_id: string; p_applicant: Json; p_application: Json }
        Returns: {
          applicant_id: string
          applied_at: string
          created_at: string
      ...
      create_job_posting_with_preset: {
        Args: { p_actor_admin_id: string; p_posting: Json }
        Returns: {
          career_type: string | null
          closes_at: string | null
          content: string
      ...
      delete_application: {
        Args: { p_actor_admin_id: string; p_application_id: string }
        Returns: {
          applicant_id: string
          applied_at: string
          created_at: string
      ...
      save_application_cover_letter_answers: {
        Args: {
      ...
      save_job_posting_cover_letter_questions: {
        Args: {
          p_actor_admin_id: string
      ...
      save_process_preset: {
        Args: { p_actor_admin_id: string; p_stages: Json }
        Returns: Json
      }
      separate_application: {
        Args: { p_actor_id: string; p_application_id: string; p_reason: string }
        Returns: {
          application_id: string
          id: string
          reason: string
      ...
      set_application_final_result: {
        ...
        SetofOptions: {
          from: "*"
          to: "application_final_results"
          isOneToOne: true
          isSetofReturn: false
        }
      }
      sync_application_current_pointer: {
        Args: { p_actor_id: string; p_application_id: string }
        Returns: {
          applicant_id: string
          applied_at: string
