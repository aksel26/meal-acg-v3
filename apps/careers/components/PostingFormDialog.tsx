  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-3xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{posting ? "공고 수정" : "새 공고 등록"}</DialogTitle>
          <DialogDescription>
            신규 공고에는 저장 시점의 기본 프로세스 프리셋이 독립 복사됩니다.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={submit} className="space-y-5">
          <div className="grid gap-4 py-2 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="posting-start-date">게시 시작일 *</Label>
              <Input
                id="posting-start-date"
                name="startDate"
                type="date"
                defaultValue={posting?.startDate || todayInSeoul()}
                required
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="posting-end-date">게시 종료일 *</Label>
              <Input
                id="posting-end-date"
                name="endDate"
                type="date"
                defaultValue={posting?.endDate || ""}
                required
              />
            </div>
