  ...
  return (
    ...
    >
      <DrawerContent className="h-full w-full max-w-md">
        <DrawerHeader className="flex-row items-center justify-between border-b px-5 py-4">
          <DrawerTitle className="text-lg">지원자 상세</DrawerTitle>
          <DrawerClose className="rounded-lg p-1 hover:bg-slate-100 text-sm text-slate-500">
            닫기
          </DrawerClose>
        </DrawerHeader>
