    ...
    >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full rounded-lg bg-gray-50 py-2.5 pl-10 pr-4 text-sm text-slate-800 placeholder:text-slate-400 outline-none focus:ring-2 focus:ring-slate-200 transition-shadow"
        />
      </div>
      ...
      <div className="md:hidden space-y-3">
        {sorted.map((notice) => (
          <div
            key={notice.id}
            onClick={() => router.push(`/notices/${notice.id}`)}
            className="rounded-xl bg-gray-50 p-4 cursor-pointer active:bg-gray-100 transition-colors"
          >
