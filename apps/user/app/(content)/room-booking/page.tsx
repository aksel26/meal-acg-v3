...
import { useRoomReservations } from "@/hooks/use-room-reservations";
import { useUpdateRoomReservation } from "@/hooks/use-room-reservation-mutations";
import { TimelineGrid } from "@/components/room-booking/TimelineGrid";
import ReservationDialog from "@/components/room-booking/ReservationDialog";
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-500 flex-wrap">
          ...
          <span className="flex items-center gap-1.5">
            <span className="inline-block h-2.5 w-2.5 rounded-sm bg-amber-200" /> 고객사
          </span>
          <span className="flex items-center gap-1.5">
            <span className="inline-block h-2.5 w-2.5 rounded-sm bg-rose-200" /> 협력사
          </span>
        </div>
      </div>
