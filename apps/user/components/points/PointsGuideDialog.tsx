      ...
      <DialogContent className="max-w-sm sm:max-w-lg max-h-[85vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-5">
          ...
          <section>
            ...
            <div className="rounded-lg bg-slate-50 border border-slate-100 p-3.5 space-y-3 text-[13px]">
              <div className="flex items-center justify-between">
                <span className="text-slate-500">반기 지급액</span>
                <span className="font-semibold text-slate-900">20만원</span>
              </div>
          ...
          <section>
            <div className="flex items-center gap-2 mb-2.5">
              <UtensilsCrossed className="h-4 w-4 text-slate-700" />
              <h3 className="font-semibold text-slate-900 text-[15px]">
                활동비
              </h3>
              <span className="text-[11px] text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">
            ...
            <div className="rounded-lg bg-slate-50 border border-slate-100 p-3.5 space-y-3 text-[13px]">
              ...
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-[1fr_auto] gap-y-1.5 gap-x-4">
                  <span className="text-slate-600">본부장</span>
                  <span className="font-semibold text-slate-900 text-right">
                    본인 포함 1인당 20만원
                  </span>
                  <span className="text-slate-600">팀장</span>
                  <span className="font-semibold text-slate-900 text-right">
                    본인 포함 1인당 15만원
                  </span>
                </div>
                <div className="mt-1 text-xs text-slate-500 bg-white border border-slate-100 rounded px-2.5 py-2">
                  <span className="font-medium text-slate-700">P&C팀 팀장</span>
          ...
          <section>
            ...
            <div className="rounded-lg bg-slate-50 border border-slate-100 p-3.5 text-[13px]">
          ...
          <div className="text-center text-xs text-slate-400 pb-1">
            문의사항은{" "}
            <span className="font-medium text-slate-600">P&C팀</span>으로
            연락해주세요
          </div>
        </div>
      </DialogContent>
