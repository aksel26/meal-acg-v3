...
} from "@/hooks/use-room-reservation-mutations";
...
export default function ReservationDialog({
  ...
  type ReservationType = "supervisor" | "interview" | "meeting" | "client_meeting" | "partner_meeting";
  const [type, setType] = useState<ReservationType>("supervisor");
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select value={type} onValueChange={(v) => setType(v as ReservationType)}>
              ...
              <SelectContent>
                <SelectItem value="supervisor">감독관</SelectItem>
                <SelectItem value="interview">면접</SelectItem>
                <SelectItem value="meeting">회의</SelectItem>
                <SelectItem value="client_meeting">고객사 미팅</SelectItem>
                <SelectItem value="partner_meeting">협력사 미팅</SelectItem>
              </SelectContent>
            </Select>
          </div>
